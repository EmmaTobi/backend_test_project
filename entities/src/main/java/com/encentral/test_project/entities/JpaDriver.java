...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "JpaDriver.findAll", query = "SELECT d from JpaDriver d "),
    @NamedQuery(name = "JpaDriver.findBySearchUsername", query = "SELECT d from JpaDriver d WHERE d.username  LIKE :username "),
    @NamedQuery(name = "JpaDriver.findBySearchOnlineStatus", query = "SELECT d from JpaDriver d WHERE d.onlineStatus LIKE :online_status ")
})
